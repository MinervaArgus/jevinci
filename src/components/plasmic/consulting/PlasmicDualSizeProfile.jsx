...
import sty from "./PlasmicDualSizeProfile.module.css"; // plasmic-import: keD8R5HWoF7XP_/css
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__xMHds,
            {
              [sty.textexpanded__xMHdsHpB]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
        ...
        <div
          className={classNames(
            ...
            sty.text__fmNkb,
            {
              [sty.textexpanded__fmNkbhpB]: hasVariant(
                $state,
                "expanded",
                "expanded"
              )
