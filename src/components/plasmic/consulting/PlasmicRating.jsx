...
import sty from "./PlasmicRating.module.css"; // plasmic-import: blx3Ph-jICFKL/css
...
function PlasmicRating__RenderFunc(props) {
  ...
  return (
    ...
    >
      <Icon10Icon
        className={classNames(projectcss.all, sty.svg__wegWx)}
        role={"img"}
      />

      <Icon10Icon
        className={classNames(projectcss.all, sty.svg___5Rtjt)}
        role={"img"}
      />

      <Icon10Icon
        className={classNames(projectcss.all, sty.svg__eoMc)}
        role={"img"}
      />
    </p.Stack>
  );
