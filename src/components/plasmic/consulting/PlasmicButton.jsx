...
import sty from "./PlasmicButton.module.css"; // plasmic-import: EGMfw0aj_iVHgo/css
    ...
    <p.Stack
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_purplePink]: hasVariant($state, "color", "purplePink"),
          ...
          [sty.rootcolor_violetBlue]: hasVariant($state, "color", "violetBlue"),
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__hlVng)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__h1EOq)}
                role={"img"}
              />
            ),
