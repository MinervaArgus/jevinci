...
import sty from "./PlasmicCompletedForecast.module.css"; // plasmic-import: n1n_V1laTAEYhF/css
...
function PlasmicCompletedForecast__RenderFunc(props) {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__jdrgn, {
          [sty.freeBoxvariants_tableRow__jdrgnRLtu]: hasVariant(
            $state,
            "variants",
            "tableRow"
          )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__sgeL, {
          [sty.freeBoxvariants_tableRow__sgeLrLtu]: hasVariant(
            $state,
            "variants",
            "tableRow"
          )
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__qasYc,
            {
              [sty.textvariants_tableRow__qasYcRLtu]: hasVariant(
                $state,
                "variants",
                "tableRow"
              )
        ...
        <div
          className={classNames(
            ...
            sty.text__q017,
            {
              [sty.textvariants_tableRow__q017RLtu]: hasVariant(
                $state,
                "variants",
                "tableRow"
              )
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__yHpxd, {
          [sty.freeBoxvariants_tableRow__yHpxdrLtu]: hasVariant(
            $state,
            "variants",
            "tableRow"
          )
      ...
      >
        <div
          className={classNames(
            ...
            sty.text__t7O3U,
            {
              [sty.textvariants_tableRow__t7O3UrLtu]: hasVariant(
                $state,
                "variants",
                "tableRow"
              )
        ...
        <div
          className={classNames(
            ...
            sty.text__us86E,
            {
              [sty.textvariants_tableRow__us86ERLtu]: hasVariant(
                $state,
                "variants",
                "tableRow"
              )
