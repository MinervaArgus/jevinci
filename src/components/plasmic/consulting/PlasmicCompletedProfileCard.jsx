...
import sty from "./PlasmicCompletedProfileCard.module.css"; // plasmic-import: 4mT1ktAU5b-2K/css
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <p.PlasmicImg
            alt={""}
            className={classNames(sty.img___5NO4P)}
            displayHeight={"50px"}
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__udsO)}
      >
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__scVzw)}
        >
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__iPq8I)}
          >
            {p.renderPlasmicSlot({
